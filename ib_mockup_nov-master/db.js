[
    [
        ...
        "“My work as a composer is to let ^^    TAREK ATOUI, I/E ISTANBUL &&https://www.ibraaz.org/interviews/130 ",
...
var new_text_content_org_pre = []
    for (var i = new_db[0].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_30-'+(getRandomInt(2)+1))
    }
    for (var i = new_db[1].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_100')
    }
    for (var i = new_db[2].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_200-'+(getRandomInt(3)+1))
    }
    for (var i = new_db[3].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_300')
    }
    for (var i = new_db[4].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_400-'+(getRandomInt(2)+1))
    }
    for (var i = new_db[5].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_500')
    }
    for (var i = new_db[6].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_700-'+(getRandomInt(2)+1))
    }
    for (var i = new_db[7].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_900')
    }
    for (var i = new_db[8].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_1000')
    }
    for (var i = new_db[9].length - 1; i >= 0; i--) {
        new_text_content_org_pre.push('sep_2000')
    }
    new_text_content_org_pre = [
    "sep_200-3",
    "sep_30-2",
    "sep_500",
    "sep_200-1",
