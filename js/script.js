...
var db = [
        ...
        [
            [
                ...
                "",
                "part of his poem titled ‘Sanctified Apple’ under the Poetry Channel",
                "sep_300"
            ],
            [
        ...
        [
            ...
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-139.png)\"></div><span class=\"quote\"></LAURA ANDERSON BARBATA</span>",
        ...
        [
            ...
            [
                ...
                "https://www.youtube.com/watch?v=GOkj7-gWPJo",
                "From “Up close with ... Newell Harry” by the Biennale of Sydney, 21/6/201",
                "sep_200-1"
            ]
        ],
        [
            ...
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-147.jpeg)\"></div><span class=\"quote\">NEWELL HARRY</span>",
                "https://www.youtube.com/watch?v=QoQpo2LYFgU",
        ...
        [
            ...
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-142.png)\"></div><span class=\"quote\">NEWELL HARRY</span>",
                "",
        ...
        [
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-148.png)\"></div><span class=\"quote\">NEPAL FEMINIST MEMORY by the NEPAL PICTURE LIBRARY</span>",
                "https://vimeo.com/359396369",
                "Feminist Memory Project – Nepal Picture Library",
                "sep_img-4"
            ],
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-143.png)\"></div><span class=\"quote\">NEPAL FEMINIST MEMORY by the NEPAL PICTURE LIBRARY</span>",
                "Screenshots from the Feminist Memory Project – Nepal Picture Library video",
                "",
                "sep_img-5"
            ],
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-144.png)\"></div><span class=\"quote\">NEPAL FEMINIST MEMORY by the NEPAL PICTURE LIBRARY</span>",
                "Screenshots from the Feminist Memory Project – Nepal Picture Library video",
                "",
                "sep_img-6"
            ]
        ...
        [
            ...
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-149.jpeg)\"></div><span class=\"quote\">PATHSHALA SOUTH ASIAN MEDIA INSTITUTE, synthesis</span>",
                "https://www.youtube.com/watch?v=OP4bl2mRxuE&ab_channel=WorldPressPhotoFoundation",
                "Inside Patshala South Asian Media Academy",
                "sep_img-7"
            ],
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-145.png)\"></div><span class=\"quote\">PATHSHALA SOUTH ASIAN MEDIA INSTITUTE, synthesis</span>",
                "",
        ...
        [
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-150.jpeg)\"></div><span class=\"quote\">BREAD AND PUPPET THEATRE, DEMONS OF SOCIETY </span>",
        ...
        [
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-146.png)\"></div><span class=\"quote\">BREAD AND PUPPET THEATRE, DEMONS OF SOCIETY </span>",
                "",
                "Hand Out, The Sky is the Institution, Peter Schumann",
                "sep_img-3"
            ],
            [
                "My insistence on that history and its complexity, which involves marrying enthusiasm for new utopic political systems with the evident failure of those same systems, has to do with my obsession, over the last ten years, with certain “role models.” It’s about trying to find ways to move forward, always believing that we cannot think of role models today if we do not understand the role models of yesterday and the day before yesterday. The way forward is about a new and inventive way of looking at society, a way of finding solutions to problems that are not necessarily the solutions that exist, but they don’t ignore the solutions that exist either.<span class=\"quote\"> NGELA FERREIRA</span>",
                "https://pinupmagazine.org/articles/interview-angela-ferreira-modern-architecture-colonialism",
                "",
                "sep_700-2"
            ],
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-151.jpeg)\"></div><span class=\"quote\"> NGELA FERREIRA</span>",
                "https://www.youtube.com/watch?v=Ca4d3XaxPd4&ab_channel=FreeSpeechTV",
                "Art Activism with Angela Ferreira by Free Speech TV, 2021",
                "sep_img-4"
            ]
        ],
        [
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-152.png)\"></div><span class=\"quote\"> NGELA FERREIRA</span>",
                "",
                "Talk Tower for Ingrid Jonker, 2012",
                "sep_img-5"
            ],
            [
                `These two projects directly address issues of ecological, political and historical traumas that linger on in what we have conventionally called "landscape"; traumas with an origin in the past but which continue on, on the present tense, actively occupying land, affecting people's lives and compromising the integrity of our existence and of the planet, well into the future.<span class=\"quote\">ALICE MICELLI</span>`,
                "",
                "Quote from the artist’s project proposal for the 17th Istanbul Biennial",
                "sep_500"
            ],
            [
                "I only go to minefields that are in the process of being demined and whose remaining active explosives have been mapped. Safety precautions are never one hundred-percent certain, but having chosen to put myself in these situations, it’s as safe as it can be. Both Projeto Chernobyl and In Depth deal with landscapes that have been rendered impenetrable by the actions of humans, so the larger question in both works is how to negotiate an access that counters these occupations.<span class=\"quote\">ALICE MICELLI</span>",
                "https://bombmagazine.org/articles/uncanny-landscapes-alice-miceli-interviewed/",
                "",
                "sep_500"
            ]
        ],
        [
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-153.png)\"></div><span class=\"quote\">ALICE MICELLI</span>",
                "https://vimeo.com/165419892",
                "Short documentary (20 minutes), Brazilian Arte1 Channel",
                "sep_img-6"
            ],
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-154.png)\"></div><span class=\"quote\">ALICE MICELLI</span>",
                "",
                "Chernobyl Project, 2007-2014",
                "sep_img-7"
            ],
            [
                "That's another aspect of production and conception that I have learned in working here: how you interact, listen, and understand something initiates the artist's or the exhibition's framework. Talking to people who know what you are discussing registers things, concerns, and ideas differently as compared to theorising them to people who may not understand what I am referring to.<span class=\"quote\">YEE I-LANN</span>",
        ...
        [
            [
                "I just want the museum to be more like a market, and more like a mat, in that true sense of an exchange of objects, knowledge, balance, and value systems: systems that are circular, restorative, and regenerative.<span class=\"quote\">YEE I-LANN</span>",
                "https://ocula.com/magazine/conversations/yee-i-lann-on-relearning-differently-in-borneo/ ",
                "",
                "sep_400-1"
            ],
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-155.jpeg)\"></div><span class=\"quote\">YEE I-LANN</span>",
                "",
                "Meet the Artists / Yee I-Lann by Art Basel, 23/03/2022",
                "sep_img-8"
            ],
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-156.png)\"></div><span class=\"quote\">YEE I-LANN</span>",
                "",
                "",
                "sep_img-9"
            ]
        ...
        [
            [
                "Footsteps is a learning process, an attempt to collect stories from the margins of wars. Stories that are urgent but for which the pathways for the conversations that lead to these stories are uncertain and difficult. Sometimes a few words, a short story, a memory or a dream could describe the experience of living with war in an explicit way.<span class=\"quote\">FOOTSTEPS</span>",
                "",
                "Project description by the Footsteps Team",
                "sep_500"
            ],
            [
                "The Footsteps Library is calling!<br><br>Footsteps Library, located in arthereistanbul in Kadıköy, has set out to establish reading groups in three languages; Turkish, English and Arabic. The library focuses on experiences and stories that are overshadowed, left in the dark and fog by wars. The reading group is a step towards discovering overlooked, invisible, and nebulous war stories.<span class=\"quote\">FOOTSTEPS</span>",
                "",
                "Project description by the Footsteps Team",
                "sep_300"
            ],
            [
                '..in the sense of claiming a degrading discourse: claiming the "crank" (the ill, the feigning ill, the one who begs and the collapse of the distinction between the three). Opacity and the right to not be understood.<span class=\"quote\">EVA EGERMANN, CRIP MAGAZINE </span>',
                "https://issuu.com/cripmagazine/docs/crip_magazine_1",
                "From Crip Magazine Issue No. 1 by Eva Egermann (14-15/24) ",
                "sep_100"
            ]
        ],
        [
            [
                "...I have often wondered how the intensity of politicization, collectivity, debates, and counter publics in various projects can be harnessed to create something sustainable in the long term that would in turn effect more concrete changes. But these changes are taking place; for what we do does something to us.<span class=\"quote\">EVA EGERMANN, CRIP MAGAZINE </span>",
            ...
            [
                "Art is a value in itself, creates space and food for thought. And this freedom - apart from economic usability and marketing - is urgently needed.<span class=\"quote\">EVA EGERMANN, CRIP MAGAZINE </span>",
            ...
            [
                "Crip magazine online<span class=\"quote\">EVA EGERMANN, CRIP MAGAZINE </span>",
                "",
        ...
        [
            [
                "<div class=\"sep_img_inner sep_img_inner_0 sep_img_inner_whole_0\" style = \"background-image:url( ../photos/image-158.png)\"></div><span class=\"quote\">LAMIA JOREIGE</span>",
                "",
                "Screenshot from Objects of War, 1999",
                "sep_img-2"
            ],
            [
...
for (var i = db.length - 1; i >= 0; i--) {
    ...
    db[i][j][0].split('<span class=\"quote\">')[1] === ''
    }
}
...
console.log(db.length)
    ...
    if(window.location.hash && window.location.hash.split('#')[1].split('-').length == 3) {
        ...
        window.location.hash = String(new Date()).substring(4).split(':')[0].slice(0,-3).replace(/ /g, '-')
    }
    if(window.location.hash && window.location.hash.split('#')[1].split('-').length == 3) {
    ...
    function get_layer_amount(){
        for (var i = time_layer_amount.length - 1; i >= 0; i--) {
            if(i>0){
        // console.log(date_range>time_layer_amount[i-1][0])
                if(date_range<time_layer_amount[i][0] && date_range>=time_layer_amount[i-1][0]){
                    return time_layer_amount[i][1]/20
                }
            }
...
function create_board(){
    for (var i = 0; i < layer_amount; i++) {
        ...
        var texture
        if(isMobile){
            texture = loader.load( "img/bgnn-"+pad(layer_amount-i, 2)+"-mobile.png" );
        }else{
...
for (var i = 0; i <db.length; i++) {
    for (var j = 0; j < db[i].length ; j++) {
        ...
        if(i <layer_amount-1 && j < db[i].length-1 ){
            // $('.credit_wrapper').append('source')
...
function add_cal(){
    for (var i = 3; i<=30; i++) {
             ...
             if(i<7){$('.calendar').append('<a class="date" href="#Apr-'+i+'-2022">Apr'+i+'</a>')}
        else if(i<14){$('.calendar').append('<a class="date" href="#Apr-'+i+'-2022">Apr'+i+'</a>')}
        else if(i<21){$('.calendar').append('<a class="date" href="#Apr-'+i+'-2022">Apr'+i+'</a>')}
        else if(i<28){$('.calendar').append('<a class="date" href="#Apr-'+i+'-2022">Apr'+i+'</a>')}
                 else{$('.calendar').append('<a class="date" href="#Apr-'+i+'-2022">Apr'+i+'</a>')}
    }
    for (var i = 1; i<=31; i++) {
        
              if(i<5){$('.calendar').append('<a class="date" href="#May-'+i+'-2022">May'+i+'</a>')}
        else if(i<12){$('.calendar').append('<a class="date" href="#May-'+i+'-2022">May'+i+'</a>')}
        else if(i<19){$('.calendar').append('<a class="date" href="#May-'+i+'-2022">May'+i+'</a>')}
        else if(i<26){$('.calendar').append('<a class="date" href="#May-'+i+'-2022">May'+i+'</a>')}
                 else{$('.calendar').append('<a class="date" href="#May-'+i+'-2022">May'+i+'</a>')}
    }
    for (var i = 1; i<=30; i++) {
        
                 if(i<2 ){$('.calendar').append('<a class="date" href="#Jun-'+i+'-2022">Jun'+i+'</a>')}
            else if(i<9 ){$('.calendar').append('<a class="date" href="#Jun-'+i+'-2022">Jun'+i+'</a>')}
            else if(i<16){$('.calendar').append('<a class="date" href="#Jun-'+i+'-2022">Jun'+i+'</a>')}
            else if(i<23){$('.calendar').append('<a class="date" href="#Jun-'+i+'-2022">Jun'+i+'</a>')}
            else if(i<30){$('.calendar').append('<a class="date" href="#Jun-'+i+'-2022">Jun'+i+'</a>')}
                     else{$('.calendar').append('<a class="date" href="#Jun-'+i+'-2022">Jun'+i+'</a>')}
    }
    for (var i = 1; i<=30; i++) {

             if(i<7 ){$('.calendar').append('<a class="date" href="#Jul-'+i+'-2022">Jul'+i+'</a>')}
        else if(i<14){$('.calendar').append('<a class="date" href="#Jul-'+i+'-2022">Jul'+i+'</a>')}
        else if(i<21){$('.calendar').append('<a class="date" href="#Jul-'+i+'-2022">Jul'+i+'</a>')}
        else if(i<28){$('.calendar').append('<a class="date" href="#Jul-'+i+'-2022">Jul'+i+'</a>')}
                 else{$('.calendar').append('<a class="date" href="#Jul-'+i+'-2022">Jul'+i+'</a>')}
    }
    for (var i = 1; i<=30; i++) {
        
             if(i<4 ){$('.calendar').append('<a class="date" href="#Aug-'+i+'-2022">Aug'+i+'</a>')}
        else if(i<11){$('.calendar').append('<a class="date" href="#Aug-'+i+'-2022">Aug'+i+'</a>')}
        else if(i<18){$('.calendar').append('<a class="date" href="#Aug-'+i+'-2022">Aug'+i+'</a>')}
        else if(i<25){$('.calendar').append('<a class="date" href="#Aug-'+i+'-2022">Aug'+i+'</a>')}
                 else{$('.calendar').append('<a class="date" href="#Aug-'+i+'-2022">Aug'+i+'</a>')}
    }
    for (var i = 1; i<=31; i++) {
        
             if(i<1 ){$('.calendar').append('<a class="date" href="#Sep-'+i+'-2022">Sep'+i+'</a>')}
        else if(i<8 ){$('.calendar').append('<a class="date" href="#Sep-'+i+'-2022">Sep'+i+'</a>')}
        else if(i<15){$('.calendar').append('<a class="date" href="#Sep-'+i+'-2022">Sep'+i+'</a>')}
        else if(i<22){$('.calendar').append('<a class="date" href="#Sep-'+i+'-2022">Sep'+i+'</a>')}
        else if(i<29){$('.calendar').append('<a class="date" href="#Sep-'+i+'-2022">Sep'+i+'</a>')}
                 else{$('.calendar').append('<a class="date" href="#Sep-'+i+'-2022">Sep'+i+'</a>')}
    }
$('.date').click(function(){
    setTimeout(function(){
    window.location.reload();
